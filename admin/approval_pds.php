                    ...
                    <div class="card bg-white mb-2">
                        <div class="card-body">
                            <div class="align-self-center">
                                <h1 class="mt-4">Personal Data Sheet Approval</h1>
                                </h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * from pending_sheet join student_enroll on pending_sheet.std_id=student_enroll.id ORDER BY pending_sheet.date_time DESC";
                                    ...
                                    ?>
                                        ...
                                        <?php include('modal_approval_pds.php'); ?>
                                    <?php
                                    }
                                    ?>
                                </tbody>

...
<head>
    ...
    <title>Medical Cert Approval</title>
</head>
<style>
    .overlay {
        position: fixed;
                    ...
                    <div class="card bg-white mb-2">
                        <div class="card-body">
                            <div class="align-self-center">
                                <h1 class="mt-4">Medical Certificate Approval</h1>
                                </h1>
                            ...
                            <div class="table-responsive">
                                <table id="datatablesSimple" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * from pending_preg join student_enroll on pending_preg.std_id=student_enroll.id ORDER BY pending_preg.date_time DESC";
                                        ...
                                        ?>
                                            ...
                                            <?php include('modal_approval_pt.php'); ?>
                                        <?php
                                        }
                                        ?>
                                    </tbody>

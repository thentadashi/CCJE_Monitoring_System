...
<head>
    ...
    <title> Archive Station Info</title>
</head>
                    ...
                    <div class="card bg-white mb-2">
                        <div class="card-body">
                            <div class="align-self-center">
                                <h1 class="mt-4">Archive Station Information Tables</h1>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class='text-right'>
                                                ...
                                                <a href='#unarchive_<?php echo $row['sti_id']; ?>' class='btn btn-warning btn-sm' data-bs-toggle='modal'><i class='bi bi-trash'></i> Archive</a>
                                            </td>
                                        </tr>

...
<head>
    ...
    <title>Parent Consent Approval</title>
</head>
<style>
    .overlay {
        position: fixed;
                    ...
                    <div class="card bg-white mb-2">
                        <div class="card-body">
                            <div class="align-self-center">
                                <h1 class="mt-4">Parent Consent Approval</h1>
                                </h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * from pending_consent join student_enroll on pending_consent.std_id=student_enroll.id ORDER BY pending_consent.date_time DESC";
                                    ...
                                    ?>
                                        ...
                                        <?php include('modal_approval_pc.php'); ?>
                                    <?php
                                    }
                                    ?>
                                </tbody>

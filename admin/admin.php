                        ...
                        <div class="card-body">
                            <div class="align-self-center">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal" data-whatever="Team Leader"> Add Admin</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class='text-right'>
                                                ...
                                                <a href='#archive_<?php echo $row['admin_id']; ?>' class='btn btn-danger btn-sm' data-bs-toggle='modal'><i class='bi bi-trash'></i> Archive</a>
                                            </td>
                                        </tr>

<!-- Delete -->
<div class="modal fade" id="delete_<?php echo $row['s_id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title " id="ModalLabel">Delete Station Assign</h5>
            ...
            <div class="modal-footer">
                ...
                <a href="delete_station_assign.php?id=<?php echo $row['s_id']; ?>" class="btn btn-danger  btn-sm"> Yes</a>
            </div>
        </div>
    </div>
</div>
...
<!-- Edit -->
<div class="modal fade" id="edit_<?php echo $row['s_id']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Edit Station Assign</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" action="edit_station_assign.php?id=<?php echo $row['s_id']; ?>">
                    <div class="row clearfix">
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <datalist id="student_list">
                                    ...
                                    $sql3 = "SELECT * from student_enroll where student_enroll.status !='1'";
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="station_id" autocomplete="off" list="station_list" class="form-control" value="<?php echo $row['sti_id']; ?>">

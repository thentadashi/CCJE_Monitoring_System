!(function (e, t) {
  ...
  var p = (function (n) {
    ...
    try {
      j.apply((t = L.call(y.childNodes)), y.childNodes),
      ...
      return (
        ...
        ue(function (e, t, n, i) {
          var r,
            ...
            h = !d || (!e && p) ? c : xe(c, a, d, n, i),
            f = g ? (v || (e ? d : u || m) ? [] : t) : h
          if ((g && g(h, f, n, i), m))
            for (r = xe(f, l), m(r, [], n, i), o = r.length; o--; )
              (s = r[o]) && (f[l[o]] = !(h[l[o]] = s))
          if (e) {
            if (v || d) {
              if (v) {
          ...
          } else (f = xe(f === t ? f.splice(u, f.length) : f)), v ? v(null, t, f, i) : j.apply(t, f)
        })
      )
    }
    function Ee (e) {
            ...
            ;(s = A(
              ...
              (i = function (e, t, n, i, r) {
                ...
                for (
                  ...
                  if (_ && o) {
                    for (
                      s = 0, t || o.ownerDocument === C || (x(o), (n = !E));
                      (a = m[s++]);
      ...
      function (i, r) {
        T.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (L[i] || T.uniqueSort(n), j.test(i) && n.reverse()),
            this.pushStack(n)
          )
        }
      }
  ...
  var z = function (e, t, n, i, r, o, s) {
      var a = 0,
        l = e.length,
        u = null == n
      if ('object' === w(n)) for (a in ((r = !0), n)) z(e, t, a, n[a], !0, o, s)
      else if (
        void 0 !== i &&
        ((r = !0),
        y(i) || (s = !0),
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var r,
          ...
          u = e.style
        if (
          (l || (t = Xe(a)), (s = T.cssHooks[t] || T.cssHooks[a]), void 0 === n)
        )
  ...
  function ut () {
    rt &&
      (!1 === E.hidden && C.requestAnimationFrame
        ? C.requestAnimationFrame(ut)
        : C.setTimeout(ut, T.fx.interval),
      T.fx.tick())
  }
  function ct () {
    return (
  ...
  T.extend(T.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !c.noBubble && !_(n)) {
          for (
            a = c.delegateType || d, xt.test(a + d) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            f.push(o), (s = o)
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = n[l]) && (n[l] = null),
              (T.event.triggered = d),
              e.isPropagationStopped() && h.addEventListener(d, Ct),
              n[d](),
              e.isPropagationStopped() && h.removeEventListener(d, Ct),
      ...
      ajax: function (e, t) {
        ...
        function u (e, t, n, i) {
          ...
          p ||
            ...
            (x.status = e),
            (x.statusText = (t || u) + ''),
            r ? _.resolveWith(v, [o, u, x]) : _.rejectWith(v, [x, u, s]),
            x.statusCode(w),
            (w = void 0),
  ...
  T.ajaxSetup({
    ...
    T.each(['top', 'left'], function (e, n) {
      T.cssHooks[n] = Ue(v.pixelPosition, function (e, t) {
        if (t) return (t = ze(e, n)), We.test(t) ? T(e).position()[n] + 'px' : t
      })
    }),
  ...
  return (
    (T.noConflict = function (e) {
      return C.$ === T && (C.$ = Gt), e && C.jQuery === T && (C.jQuery = Yt), T
    }),
    e || (C.jQuery = C.$ = T),
    T
  )
  ...
  (function (e, t) {
      ...
      R = (function () {
        ...
        return (
          ...
          (e._getConfig = function (e) {
            return (e = l({}, A, e)), g.typeCheckConfig(x, e, D), e
          }),
    ...
    p(document).on(
      ...
      (p.fn[x] = R._jQueryInterface),
      (p.fn[x].Constructor = R),
      (p.fn[x].noConflict = function () {
        return (p.fn[x] = S), R._jQueryInterface
      })
    var H = 'collapse',
      M = 'bs.collapse',
      P = '.' + M,
          ...
          (e.show = function () {
            ...
            if (
              ...
              if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
                ...
                p(this._element)
                  .one(g.TRANSITION_END, function () {
                    p(n._element).removeClass(V).addClass(U).addClass(z),
                      (n._element.style[r] = ''),
            ...
            if (!this._isTransitioning && p(this._element).hasClass(z)) {
              ...
              if ((p(this._element).trigger(t), !t.isDefaultPrevented())) {
                ...
                ;(this._element.style[n] =
                  ...
                  p(this._element).addClass(V).removeClass(U).removeClass(z)
                ...
                p(this._element)
                  .one(g.TRANSITION_END, function () {
                    e.setTransitioning(!1),
                      p(e._element).removeClass(V).addClass(U).trigger(B.HIDDEN)
                  })
    ...
    p(document).on(B.CLICK_DATA_API, Q, function (e) {
      ...
      (p.fn[H] = X._jQueryInterface),
      (p.fn[H].Constructor = X),
      (p.fn[H].noConflict = function () {
        return (p.fn[H] = q), X._jQueryInterface
      })
    for (
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var s,
                ...
                C = ae(e.instance.popper),
                E = ye(C),
                T = { position: r.position },
                S =
                  ((s = e),
                  (a = window.devicePixelRatio < 2 || !Le),
              ...
              if (
                ((w =
                  'bottom' === A
                    ? 'HTML' === C.nodeName
                      ? -C.clientHeight + S.bottom
                      : -E.height + S.bottom
                    : S.top),
                (b =
                  'right' === D
                    ? 'HTML' === C.nodeName
                      ? -C.clientWidth + S.right
                      : -E.width + S.right
                    : S.left),
                x && N)
              )
    ...
    var Fe = 'dropdown',
      ...
      Qe = {
        ...
        SHOWN: 'shown' + ze,
        CLICK: 'click' + ze,
        CLICK_DATA_API: 'click' + ze + Ue,
        KEYDOWN_DATA_API: 'keydown' + ze + Ue,
        KEYUP_DATA_API: 'keyup' + ze + Ue
      },
      Xe = 'disabled',
      Ke = 'show',
      ...
      tt = (function () {
        ...
        return (
              ...
              if ((u._clearMenus(), !t)) {
                ...
                if ((p(e).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  'ontouchstart' in document.documentElement &&
                    ...
                    p(e).toggleClass(Ke).trigger(p.Event(Qe.SHOWN, n))
                }
              }
            }
          }),
            ...
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(Ke),
                  p(n).toggleClass(Ke).trigger(p.Event(Qe.SHOWN, e)))
            }
          }),
          (e.hide = function () {
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(Ke),
                  p(n).toggleClass(Ke).trigger(p.Event(Qe.HIDDEN, e)))
            }
          }),
          (e.dispose = function () {
          ...
          (e._addEventListeners = function () {
            var t = this
            p(this._element).on(Qe.CLICK, function (e) {
                  ...
                  if (
                    ...
                    p(r).trigger(l),
                      l.isDefaultPrevented() ||
                        ...
                        p(a).removeClass(Ke),
                        p(r).removeClass(Ke).trigger(p.Event(Qe.HIDDEN, s)))
                  }
                }
              }
          }),
          ...
          (u._dataApiKeydownHandler = function (e) {
            if (
              ...
              (e.preventDefault(),
              e.stopPropagation(),
              !this.disabled && !p(this).hasClass(Xe))
            ) {
    ...
    p(document)
      .on(Qe.KEYDOWN_DATA_API, Ge, tt._dataApiKeydownHandler)
      .on(Qe.KEYDOWN_DATA_API, Je, tt._dataApiKeydownHandler)
      .on(Qe.CLICK_DATA_API + ' ' + Qe.KEYUP_DATA_API, tt._clearMenus)
      .on(Qe.CLICK_DATA_API, Ge, function (e) {
        e.preventDefault(),
          e.stopPropagation(),
    ...
    ;(p.fn[_t] = Rt._jQueryInterface),
      ...
      (p.fn[_t].noConflict = function () {
        return (p.fn[_t] = xt), Rt._jQueryInterface
      })
    var Ht = 'popover',
      Mt = 'bs.popover',
      Pt = '.' + Mt,
      ...
      zt = l({}, Rt.DefaultType, { content: '(string|element|function)' }),
      Ut = {
        HIDE: 'hide' + Pt,
        HIDDEN: 'hidden' + Pt,
        SHOW: 'show' + Pt,
    ...
    var $t = 'scrollspy',
      ...
      on = (function () {
        ...
        return (
          ...
          (e.dispose = function () {
            p.removeData(this._element, Qt),
              p(this._scrollElement).off(Xt),
              (this._element = null),
    ...
    ;(p.fn[pn] = Cn._jQueryInterface),
      (p.fn[pn].Constructor = Cn),
      (p.fn[pn].noConflict = function () {
        return (p.fn[pn] = vn), Cn._jQueryInterface
      }),
      (function () {
        if (void 0 === p)
          throw new TypeError(
    ...
    ;(e = function (R) {
      ...
      ;(e = function () {
        ...
        (R.fn.simpledraw = function (e, t, n, i) {
          ...
          return (
            e === z && (e = R(this).innerWidth()),
            t === z && (t = R(this).innerHeight()),
        ...
        (f = t({
          ...
          reset: function (e) {
            ;(this.splist = []),
              this.tooltip && e && (this.tooltip.remove(), (this.tooltip = z))
          },
        ...
        (R.fn.sparkline.options = t({
          ...
          getTagSetting: function (e) {
            ...
            if (this.tagValCache.hasOwnProperty(e)) t = this.tagValCache.key
              ...
              if ((t = this.tag.getAttribute(o + e)) === z || null === t) t = _
          ...
          get: function (e, t) {
            ...
            return i !== _ ? i : (n = this.mergedOptions[e]) === z ? t : n
          }
        })),
          ...
          setRegionHighlight: function (e, t, n) {
            ...
            return t > this.canvasWidth ||
              ...
              : r !== (i = this.getRegion(e, t, n)) &&
                  (r !== z && o && this.removeHighlight(),
                  (this.currentRegion = i) !== z && o && this.renderHighlight(),
                  !0)
          },
          ...
          t(R.fn.sparkline._base, {
            ...
            drawNormalRange: function (e, t, n, i, r) {
              var o = this.options.get('normalRangeMin'),
                ...
                l = B.round((n * (s - o)) / r)
              this.target
                .drawRect(e, a, i, l, z, this.options.get('normalRangeColor'))
                .append()
            },
            render: function () {
              var e,
              ...
              if (
                  ...
                  i = r = 0,
                    ...
                    N &&
                      (((_ =
                        ...
                        E.get('minSpotColor') ||
                        (E.get('spotColor') && x[n] === this.miny)) &&
                        (A -= B.ceil(N)),
                      (_ ||
                        E.get('maxSpotColor') ||
                        (E.get('spotColor') && x[n] === this.maxy)) &&
                        ((A -= B.ceil(N)), (i += B.ceil(N))),
                      (_ ||
                        ((E.get('minSpotColor') || E.get('maxSpotColor')) &&
                          (x[0] === this.miny || x[0] === this.maxy))) &&
                        ((r += B.ceil(N)), (S -= B.ceil(N))),
                      (_ ||
                        E.get('spotColor') ||
                        E.get('minSpotColor') ||
                        (E.get('maxSpotColor') &&
                          (x[n] === this.miny || x[n] === this.maxy))) &&
                        (S -= B.ceil(N))),
                    A--,
                    E.get('normalRangeMin') === z ||
                ...
                if (N && E.get('valueSpots'))
                  for (
                    (y = E.get('valueSpots')).get === z && (y = new W(y)),
                      C = 0;
                    C < p;
                    C++
                  )
                    (b = y.get(x[C])) &&
                      T.drawCircle(
                        r + B.round((w[C] - this.minx) * (S / e)),
                        i + B.round(A - A * ((x[C] - this.miny) / t)),
                        N,
                        z,
                        b
                      ).append()
          ...
          t(R.fn.sparkline._base, r, {
            ...
            init: function (e, t, n, i, r) {
              ...
              ;(this.max = m = B.max.apply(B, u)),
                ...
                (this.xaxisOffset = p),
                (f = _ ? B.max.apply(B, l) + B.max.apply(B, L) : m - g),
                (this.canvasHeightEf =
            ...
            calcColor: function (e, t, n) {
              ...
              return (
                (i = this.stacked
                  ...
                  ? a.get('negBarColor')
                  : a.get('barColor')),
                0 === t && a.get('zeroColor') !== z && (i = a.get('zeroColor')),
          ...
          t(R.fn.sparkline._base, {
            ...
            init: function (e, t, n, i, r) {
              ...
              l._super.init.call(this, e, t, n, i, r),
                ...
                (o = B.min.apply(B, t)),
                (s = B.max.apply(B, t)),
                (o = n.get('base') === z ? (o < 0 ? o : 0) : n.get('base')),
                (this.min = o),
                (this.max = s),
                (this.range = s - o),
                (this.shapes = {}),
              ...
              for (o = d.length, r = 0; r < o; r++) {
                if (((i = n = g), 0 < p && (i = g + f * (d[r] / p)), e === r))
                  return (
                    ...
                    a.drawPieSlice(u, u, u - c, n, i, z, s)
                  )
                g = i
              }
            },
          ...
          t(R.fn.sparkline._base, {
            ...
            render: function () {
              var e,
                ...
                m = this.canvasHeight,
                v =
                  p.get('chartRangeMin') === z
                    ? B.min.apply(B, f)
                    : p.get('chartRangeMin'),
                y =
                  p.get('chartRangeMax') === z
                    ? B.max.apply(B, f)
                    : p.get('chartRangeMax'),
                _ = 0
              if (w._super.render.call(this)) {
                if (p.get('raw'))
                  ...
                  for (e = s = z, l = 0; l < d; l++)
                    e === z && f[l] > i - n * p.get('outlierIQR') && (e = f[l]),
    ...
    ;(s.prototype = {
      ...
      initFill: function () {
        function e () {
          ...
          ;(e.width = n.size),
            (e.height = n.size),
            e.getContext('2d').drawImage(t, 0, 0, o, o),
            (n.arcFill = n.ctx.createPattern(e, 'no-repeat')),
        ...
        if (
          ('string' == typeof i && (i = { color: i }),
          i.color && (this.arcFill = i.color),
          i.gradient)
        ) {
          var s = i.gradient
          if (1 == s.length) this.arcFill = s[0]
            ...
            for (
              var a = i.gradientAngle || 0,
                l = i.gradientDirection || [
                  (o / 2) * (1 - Math.cos(a)),
                  (o / 2) * (1 + Math.sin(a)),
                  (o / 2) * (1 + Math.cos(a)),
                  (o / 2) * (1 - Math.sin(a))
                ],
                u = r.createLinearGradient.apply(r, l),
                c = 0;
              c < s.length;
              c++
            ) {
        ...
        i.image &&
          (i.image instanceof Image
            ? (t = i.image)
            : ((t = new Image()).src = i.image),
      ...
      drawArc: function (e) {
        if (0 !== e) {
          ...
          t.save(),
            t.beginPath(),
            this.reverse
              ? t.arc(n, n, n - i / 2, r - 2 * Math.PI * e, r)
              : t.arc(n, n, n - i / 2, r, r + 2 * Math.PI * e),
            (t.lineWidth = i),
      ...
      (d.circleProgress = { defaults: s.prototype }),
      ...
      (d.fn.circleProgress = function (r, e) {
        ...
        return this.each(function () {
          var e = d(this),
            t = e.data(o),
            n = d.isPlainObject(r) ? r : {}
          if (t) t.init(n)
          else {
            var i = d.extend({}, e.data())
            'string' == typeof i.fill && (i.fill = JSON.parse(i.fill)),
              'string' == typeof i.animation &&
                (i.animation = JSON.parse(i.animation)),
              ((n = d.extend(i, n)).el = e),
              (t = new s(n)),
              e.data(o, t)
          }

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="../team_leader/pending_proccess/proccess_wr.php" method="get" enctype="multipart/form-data">
                    ...
                    <input type='hidden' name='s_week' value='<?php echo $row['start_week']; ?>' />
                    <input type='hidden' name='e_week' value='<?php echo $row['end_week']; ?>' />
            ...
            <div class="modal-body">
                ...
                <form action="../team_leader/pending_proccess/proccess_wr.php" method="get" enctype="multipart/form-data">
                    <div class="form-outline w-100 px-3">
                        ...
                        <textarea class="form-control" name="reason" id="textAreaExample" rows="4" style="background: #fff;" placeholder="Type here..." required></textarea>
                    </div>
            </div>
            <div class="modal-footer">
                <input type='hidden' name='id' value='<?php echo $row['p_id']; ?>' />

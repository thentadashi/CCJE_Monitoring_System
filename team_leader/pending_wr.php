...
<head>
    ...
    <title>Weekly Report Approval</title>
</head>
<style>
    .overlay {
        position: fixed;
                    ...
                    <div class="card bg-white mb-2">
                        <div class="card-body">
                            <div class="align-self-center">
                                <h1 class="mt-4">Weekly Report Approval</h1>
                                </h1>
                            ...
                            <div class="table-responsive">
                                <table id="datatablesSimple" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * from pending_wr join student_enroll on pending_wr.std_id=student_enroll.id ORDER BY pending_wr.date_time DESC";
                                        ...
                                        ?>
                                            ...
                                            <?php include('modal_proccess/modal_approval_wr.php'); ?>
                                        <?php
                                        }
                                        ?>
                                    </tbody>

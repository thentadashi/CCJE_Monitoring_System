...
<head>
    ...
    <title>Team Weekly Report Tables</title>
</head>
<style>
    .overlay {
        position: fixed;
                    ...
                    <div class="card bg-white mb-2">
                        <div class="card-body">
                            <div class="align-self-center">
                                <h1 class="mt-4">Team Weekly Reports</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    $sttid= $_SESSION["userstation"];
                                    $sql = "SELECT * FROM week_accom JOIN student_station on student_station.s_id=week_accom.std_id JOIN student_enroll on week_accom.std_id=student_enroll.id where student_enroll.status !='1' AND student_station.sti_id='$sttid' ORDER BY week_accom.date_time DESC;";

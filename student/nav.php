...
$result = $mysqli->query($inboxQuery);
            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="week_accom.php">
                        <div class="sb-nav-link-icon"><i class="bi bi-journal-album"></i></i></div>
                        My Weekly Reports
                    </a>
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts3" aria-expanded="false" aria-controls="collapseLayouts" onclick="toggleCollapse()">
                        ...
                        ?>
                        <div class="messageContainer" data-message-id="<?php echo $message_id; ?>">
...
//     var messageId = document.querySelector('.messageContainer').dataset.messageId;
...
<script>
    // Function to toggle the visibility of the collapsed navigation links
    function toggleCollapse() {
        var collapseElement = document.getElementById("collapseLayouts3");
